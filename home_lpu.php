...
while($count>0){
	...
	echo ' <li><a href="lpu_check.php">'.$row1['Name'].'<i class="fa fa-caret-down" style="font-size:22px;float:right;" ></i></a></li>';
	?>	
<?php
...
<div class="pagination">
  ...
  <br>
  <i class="fa fa-plus-circle" onclick="window.location.href='lpu_assignement.php'" style="font-size:36px;margin-left: 550px;margin-top: 80px;"></i>
